...
<html>
    ...
    <p><a href="<?= HOST ?>dashboard.php">Dashboard</a> | Ingelogd als <?= $user->getEmail() ?> | <a href="<?= HOST ?>oplossing-CRUD-CMS-logout-process.php">uitloggen</a></p>
    ...
    <a href="<?= HOST ?>artikel-overzicht.php">Artikels</a>
