...
<html>
    ...
    <p><a href="<?= HOST ?>dashboard.php">Dashboard</a> | Ingelogd als <?= $user->getEmail() ?> | <a href="<?= HOST ?>oplossing-file-upload-logout-process.php">uitloggen</a></p>
    ...
    <form action="<?= HOST ?>gegevens-proces.php" method="POST" enctype="multipart/form-data">
        <ul>
            <li>
