...
<body>
<p><a href="<?= HOST ?>dashboard.php">Dashboard</a> | Ingelogd als <?= $user->getEmail() ?> | <a href="<?= HOST ?>logout-proces.php">uitloggen</a></p>
...
<form action="<?= HOST ?>artikel-toevoegen-proces.php" method="POST">
