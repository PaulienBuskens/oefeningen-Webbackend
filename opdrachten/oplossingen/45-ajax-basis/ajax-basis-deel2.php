...
try{
    ...
    //bieren
    $bierenQuery = 'SELECT bieren.naam FROM bieren WHERE bieren.brouwernr = :brouwernummer';
...
<head>
    ...
    <title>ajax basis deel 2</title>
</head>
<body>
<h1>Oplossing AJAX basis: deel2</h1>
...
function loadXMLDoc(){
    ...
    xmlhttp.open("GET", "ajax-basis-deel2-api.php", true);
